...
from adodbapi.ado_consts import adGUID
from fontTools.ttLib.tables.ttProgram import instructions

print("\nWelcome to the ISA simulator! - Designed by Reinis Krauja")
    ...
    def __init__(self):
        ...
        try:
            for entry in file_content_list:
                ...
                self.instruction_memory[int(address)] = {'opcode': str(instruction[0]), 'op_1': '-', 'op_2': '-',
                                                         'op_3': '-'}
...
def execute_instruction(opcode, op_1, op_2, op_3):
